...
# leaf_convection_model_choice, soil_hydraulic_model_choice, etc. there).
...
site_name = "GWW"  # "CapeTribulation", "Calperum", "Whroo", "Wallaby", "GWW", "Longreach", "TiTreeEast", "AliceSpringsMulga"
years = [2020]
...
plot_end   = DateTime(years[1], 12, 31, 23)
...
# Most meaningful at Whroo/Wallaby (real sub-canopy sensors); set profile_times
# to any range of hours you want one profile panel per hour for.
profile_times = DateTime(years[1], 1, 18, 4):Hour(1):DateTime(years[1], 1, 18, 15)
